...
urlpatterns = [
    ...
    #url(r'^viewreport/(?P<pk>[0-9]+)/success/$', views.delete_report, name='viewreport'),
    ...
    #url(r'^viewallreport/(?P<pk>[0-9]+)/$', views.delete_report, name='delete_report'),
    #url(r'^deletereport/(?P<pk>[0-9]+)/$', views.deletereport, name='deletereport'),
